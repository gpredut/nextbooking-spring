...
--
-- Host: 127.0.0.1    Database: nextbooking
-- ------------------------------------------------------
...
CREATE TABLE `reservations` (
  ...
  CONSTRAINT `FK3kocu7c52008941ed3rvqsflm` FOREIGN KEY (`guest_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-10 14:27:11
